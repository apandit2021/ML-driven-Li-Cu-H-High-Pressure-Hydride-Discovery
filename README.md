...
- **outputs_hull_mattersim/** — Convex hull plots and data (several .csv files and most stable structures in .vasp format) from MatterGen + MatterSim (ML) at different pressures
